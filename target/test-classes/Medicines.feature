Feature: Medicines
  ...
  Scenario: Add new medicine
    ...
    |Brufen 200mg tablets| in 28 days  | in 56 days | in 90 days|Choose Date|
    ...
    And I see You have added Brufen 200mg tablets to your cabinet
    ...
    Scenario: Edit existing medicine
      ...
      When I click on medicines option
      And I see Brufen 200mg tablets into my medicine list
      When I click on Brufen 200mg tablets
